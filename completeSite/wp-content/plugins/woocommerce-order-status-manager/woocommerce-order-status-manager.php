...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.2.0', __( 'WooCommerce Order Status Manager', 'woocommerce-order-status-manager' ), __FILE__, 'init_woocommerce_order_status_manager', array( 'minimum_wc_version' => '2.3.6', 'backwards_compatible' => '4.2.0' ) );
...
class WC_Order_Status_Manager extends SV_WC_Plugin {
	...
	/** plugin text domain, DEPRECATED as of 1.4.0 */
	 ...
	 *
	 * @since 1.3.0
	 * @param int|object|string $status Post ID, post object or post slug
