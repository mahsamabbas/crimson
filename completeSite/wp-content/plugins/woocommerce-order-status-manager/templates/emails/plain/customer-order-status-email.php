...
echo sprintf( __( 'Order date: %s', 'woocommerce-order-status-manager' ), date_i18n( wc_date_format(), strtotime( $order->order_date ) ) ) . "\n";
...
echo __( 'Your details', 'woocommerce-order-status-manager' ) . "\n\n";
