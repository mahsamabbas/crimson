...
class WC_Order_Status_Manager_Order_Statuses {
	...
	public function __construct() {
		...
		add_action( 'pre_get_posts', array( $this, 'order_statuses_custom_sorting' ), 1 );
	...
	public function order_statuses( array $order_statuses ) {
		...
		return array_merge( $order_statuses, $filtered_statuses );
	}


	/**
	 * Permit downloads if the custom order status is marked as paid
	 *
	 * @since 1.3.0
