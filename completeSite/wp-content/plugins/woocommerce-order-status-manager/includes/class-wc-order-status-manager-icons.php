 ...
 *
 * This class handles the setup and extraction of font icones
 *
 * @since 1.0.0
 */
class WC_Order_Status_Manager_Icons {
	 ...
	 * @param string $class_prefix The class prefix that every icon class uses. If
	 *                             icon classes are named like `dashicons-admin`, then
	 *                             the prefix would be `dashicons`.
