...
class WC_Order_Status_Manager_Frontend {
	...
	*/
	public function __construct() {
		...
		// Add status description to recent orders in my-account screen (WC 2.5+)
	...
	private function screen_has_order_status() {
		...
		return ( ! empty( $wp->query_vars['view-order'] ) || ( isset( $wp->query_vars['pagename'] ) && 'my-account' === $wp->query_vars['pagename'] ) );
	}
