...
function wpb_wiz_product_gallery_images(){
	...
	if ( $attachment_count > 0 ){
		...
		ob_start();
		?>
			<div id="wpb_wiz_gallery" class="thumbnails <?php echo 'columns-' . $columns; ?>">
				...
				<?php 
		    		...
		    		foreach ( $attachments as $attachment ) {
		    			...
		    			?>
		    				<a class="<?php echo $image_class; ?>" href="#" data-image="<?php echo $attachment_resized[0]; ?>" data-zoom-image="<?php echo $attachment_full[0]; ?>"> 
		    					<img id="wpb_wiz_img_id" src="<?php echo $attachment_resized[0]; ?>" /> 
		    				</a> 
		    			<?php
