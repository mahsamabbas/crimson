<div class="notice notice-info <?php echo ($this->file_id ==1) ? 'wsoe-addon-expired' : 'wsoe-scheduler-expired'; ?> is-dismissible">
	<p><?php _e( sprintf('<strong>Order export scheduler and logger:</strong> Your license has been expired and you no longer would be able to receive updates. Please renew your license!'), 'woocommerce-simply-order-export-add-on'); ?></p>
	<p>
